...
NTSTATUS DriverEntry(PDRIVER_OBJECT pDriverObject,
  ...
  InitializeObjectAttributes(&oa, &usMfltPortName,
                             ...
                             psd);
  ntStatus = FltCreateCommunicationPort(driverData.pFilter,
  &driverData.pServerPort, &oa, NULL, COMPortConnect, COMPortDisconnect, NULL,
  1); FltFreeSecurityDescriptor(psd); if (ntStatus != STATUS_SUCCESS) {
...
//       ntStatus =
//           FltSendMessage(driverData.pFilter, &driverData.pClientPort,
//           pcSendBuffer,
...
//       hProc, PROCESS_ALL_ACCESS, *PsProcessType, KernelMode, &peprocess,
//       NULL);
//   if (ntStatus != STATUS_SUCCESS) {
